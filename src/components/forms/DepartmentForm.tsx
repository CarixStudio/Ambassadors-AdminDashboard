...
export default function DepartmentForm({ initialData, onSuccess, onCancel }: DepartmentFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Internal code for financial tracking.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
